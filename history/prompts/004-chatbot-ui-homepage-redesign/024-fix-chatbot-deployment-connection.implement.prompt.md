---
id: 024
title: Fix Chatbot Connection after Deployment
stage: implement
date: 2025-12-18
surface: {{SURFACE}}
model: {{MODEL}}
...
Fixed the chatbot connection issue after deployment by making the backend URL configurable in docusaurus.config.js and ChatWidget.tsx.
