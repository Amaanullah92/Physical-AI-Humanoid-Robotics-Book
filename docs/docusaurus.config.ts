...
const config: Config = {
  ...
  organizationName: 'Amaanullah92', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {to: '/docs/chapters/introduction', label: 'Introduction', position: 'left'},
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'GitHub',
              href: 'https://github.com/Amaanullah92/Physical-AI-Humanoid-Robotics-Book/tree/main/',
            },
          ],
        },
      ],
